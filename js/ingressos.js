...
document
  .getElementById("form-ingresso")
  .addEventListener("submit", function (e) {
    e.preventDefault();

    const cpf = document.getElementById("cpf").value.trim();
    const sessaoIndex = document.getElementById("sessao").value;
    const assento = document
      .getElementById("assento")
      .value.trim()
      .toUpperCase();
    ...
    const ingressoDuplicado = ingressos.find(
      (ing) => ing.sessaoIndex === sessaoIndex && ing.assento === assento
    );
